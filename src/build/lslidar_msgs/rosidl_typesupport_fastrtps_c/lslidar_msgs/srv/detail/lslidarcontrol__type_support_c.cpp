...
#include "lslidar_msgs/srv/detail/lslidarcontrol__rosidl_typesupport_fastrtps_c.h"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lasercontrol
  {
    cdr << ros_message->lasercontrol;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name lasercontrol
  {
    size_t item_size = sizeof(ros_message->lasercontrol);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, lasercontrol) +
      last_member_size
      ) == ret_val;
  }
...
// already included above
// #include "lslidar_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "lslidar_msgs/srv/lslidarcontrol.h"
