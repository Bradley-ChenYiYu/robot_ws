    ...
    def listen_and_process(self):
        while rclpy.ok():
            ...
            with sr.Microphone() as source:
                ...
                playsound("/home/jason9308/robot_ws/sound/start.mp3")
                audio_data = self.recognizer.listen(source)
                playsound("/home/jason9308/robot_ws/sound/finish.mp3")
            ...
            rclpy.spin_once(self, timeout_sec=0.1) # spin once 讓其他訂閱者有機會接收訊息
