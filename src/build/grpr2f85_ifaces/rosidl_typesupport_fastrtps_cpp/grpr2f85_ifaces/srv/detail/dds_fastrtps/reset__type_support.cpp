...
#include "grpr2f85_ifaces/srv/detail/reset__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = grpr2f85_ifaces::srv::Reset_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grpr2f85_ifaces::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<grpr2f85_ifaces::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  return &grpr2f85_ifaces::srv::typesupport_fastrtps_cpp::_Reset_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grpr2f85_ifaces::srv::Reset_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grpr2f85_ifaces::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grpr2f85_ifaces::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grpr2f85_ifaces::srv::typesupport_fastrtps_cpp::_Reset_Response__handle;
}
...
{
  return &grpr2f85_ifaces::srv::typesupport_fastrtps_cpp::_Reset__handle;
}
