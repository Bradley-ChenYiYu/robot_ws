...
class Reset_Request(metaclass=Metaclass_Reset_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.get = kwargs.get(
            'get', Reset_Request.GET__DEFAULT)
...
class Metaclass_Reset(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from grpr2f85_ifaces.srv import _reset
...
class Reset(metaclass=Metaclass_Reset):
    from grpr2f85_ifaces.srv._reset import Reset_Request as Request
    from grpr2f85_ifaces.srv._reset import Reset_Response as Response
