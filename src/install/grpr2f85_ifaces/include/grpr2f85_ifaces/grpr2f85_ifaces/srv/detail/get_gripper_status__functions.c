...
grpr2f85_ifaces__srv__GetGripperStatus_Request__create()
{
  ...
  grpr2f85_ifaces__srv__GetGripperStatus_Request * msg = (grpr2f85_ifaces__srv__GetGripperStatus_Request *)allocator.allocate(sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Request));
  bool success = grpr2f85_ifaces__srv__GetGripperStatus_Request__init(msg);
  if (!success) {
...
grpr2f85_ifaces__srv__GetGripperStatus_Request__destroy(grpr2f85_ifaces__srv__GetGripperStatus_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    grpr2f85_ifaces__srv__GetGripperStatus_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence__init(grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grpr2f85_ifaces__srv__GetGripperStatus_Request * data = NULL;

  if (size) {
    data = (grpr2f85_ifaces__srv__GetGripperStatus_Request *)allocator.zero_allocate(size, sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = grpr2f85_ifaces__srv__GetGripperStatus_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        grpr2f85_ifaces__srv__GetGripperStatus_Request__fini(&data[i - 1]);
      }
...
grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence__fini(grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      grpr2f85_ifaces__srv__GetGripperStatus_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence * array = (grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence *)allocator.allocate(sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence__init(array, size);
  if (!success) {
...
grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence__destroy(grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence__are_equal(const grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence * lhs, const grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!grpr2f85_ifaces__srv__GetGripperStatus_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  grpr2f85_ifaces__srv__GetGripperStatus_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    grpr2f85_ifaces__srv__GetGripperStatus_Request * data =
      (grpr2f85_ifaces__srv__GetGripperStatus_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!grpr2f85_ifaces__srv__GetGripperStatus_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          grpr2f85_ifaces__srv__GetGripperStatus_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!grpr2f85_ifaces__srv__GetGripperStatus_Request__copy(
...
grpr2f85_ifaces__srv__GetGripperStatus_Response__init(grpr2f85_ifaces__srv__GetGripperStatus_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->result)) {
    grpr2f85_ifaces__srv__GetGripperStatus_Response__fini(msg);
    return false;
  }
  {
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grpr2f85_ifaces__srv__GetGripperStatus_Response * msg = (grpr2f85_ifaces__srv__GetGripperStatus_Response *)allocator.allocate(sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Response));
  bool success = grpr2f85_ifaces__srv__GetGripperStatus_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence__init(grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grpr2f85_ifaces__srv__GetGripperStatus_Response * data = NULL;

  if (size) {
    data = (grpr2f85_ifaces__srv__GetGripperStatus_Response *)allocator.zero_allocate(size, sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = grpr2f85_ifaces__srv__GetGripperStatus_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        grpr2f85_ifaces__srv__GetGripperStatus_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence__fini(grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      grpr2f85_ifaces__srv__GetGripperStatus_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence * array = (grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence *)allocator.allocate(sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence__destroy(grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence__are_equal(const grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence * lhs, const grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!grpr2f85_ifaces__srv__GetGripperStatus_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  grpr2f85_ifaces__srv__GetGripperStatus_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(grpr2f85_ifaces__srv__GetGripperStatus_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    grpr2f85_ifaces__srv__GetGripperStatus_Response * data =
      (grpr2f85_ifaces__srv__GetGripperStatus_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!grpr2f85_ifaces__srv__GetGripperStatus_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          grpr2f85_ifaces__srv__GetGripperStatus_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!grpr2f85_ifaces__srv__GetGripperStatus_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
